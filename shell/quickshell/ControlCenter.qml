...
// flyout, rebuilt as a tabbed Control Center - Home (quick-toggle grid,
// volume, media, battery) and System (the original flat info-row list).
// Not a port of Noctalia v5's own Control Center (its code is Wayland/
// OpenGL-native, nothing to port), just the same idea built from Zaris's
// existing services: a richer, more scannable landing spot than one long
// column of label+widget rows. Deliberately skipped two pieces of
// Noctalia's version that have no Zaris equivalent: an avatar/large clock
// (the bar's own clock is already visible behind this panel, wherever it's
// opened from) and weather+forecast (no weather service exists here).
//
            ...
            NTabView {
                ...
                Column {
                    ...
                    Row {
                        ...
                        NText { text: "Clipboard"; width: root.labelWidth; color: Colors.textMuted; pointSize: Style.fontSizeS }
                    ...
                    Row {
                        ...
                        NText { text: "Wallpaper"; width: root.labelWidth; color: Colors.textMuted; pointSize: Style.fontSizeS }
